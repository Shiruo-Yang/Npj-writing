# NPJ official rules summary

Use the current Nature npj content-type and submission pages as the operational source of truth before final submission.
...
- Title: up to 15 words, free of punctuation, idioms, and puns.
- Abstract: no subheadings, up to 150 words.
- Introduction: no subheadings.
- Results: use subheadings.
- Discussion: no subheadings; no separate Limitations or Conclusions section.
- Methods: use subheadings; Methods descriptions should be in the main manuscript file.
- Data availability: mandatory.
- Code availability: include where applicable.
- Acknowledgments: funding is declared here; do not use a separate Funding statement.
- Author contributions: mandatory and should refer to all authors individually by initials.
- Competing interests: mandatory; state if none.
